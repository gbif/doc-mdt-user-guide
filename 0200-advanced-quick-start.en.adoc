...
You should now have an good idea of how you may adapt your own datasets and process them with THE_TOOL. If so, select a <<template  You may also try to process <<example3>>.