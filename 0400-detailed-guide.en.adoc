...
*Users with prepared datasets ready to process*: skip this section and go to: <<detailed_select_mdt>>.
...
* Still learning or testing? Use the https://mdt.gbif-test.org/[MDT Sandbox (Demo Installation)].
* Got a real dataset? Identify and use the most relevant hosted MDT installation for the dataset. #how can we guide/link here??#
* Can't find a relevant MDT installation? Use the https://mdt.gbif.org/[GBIF Conversion MDT].

[[detailed_landing]]
=== Landing page

. Log in with https://www.gbif.org/user/profile[*GBIF account*] (not UAT account as previously!)
