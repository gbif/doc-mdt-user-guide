...
* Still learning or testing? Use the https://sandbox-mdt.gbif-uat.org/[MDT Sandbox (Demo Installation)].
...
NOTE: User that have prepared datasets using the GBIF Conversion MDT should investigate whether there is a relevant hosted MDT adminstered by a relevant GBIF node. #how can we guide here?#
