...
*User with prepared dataset?*: skip to: <<detailed_select_mdt>>.
...
Identify and use the most relevant MDT installation for the user/dataset.

GBIF node MDTs: 

[.underline]#Africa#

* https://tg.mdt.gbif.org/[Togo]

[.underline]#Asia#

[.underline]#Europe and Central Asia#  
...
* https://mdt-gbif.nbnatlas.org/[United Kingdom of Great Britain and Northern Ireland]

[.underline]#Latin America and the Caribbean#  
...
* https://mdt.gbif.us/[United States of America]

[.underline]#Oceania#

[.underline]#Regional MDTs#  

* https://eca.mdt.gbif.org/[Europe and Central Asia]
* https://lac.mdt.gbif.org/[Latin America and the Caribbean]

[.underline]#Other MDTs#  

* https://mdt.obis.org/[OBIS]


*Can't find a relevant MDT installation?*

Use the https://mdt.gbif.org/[GBIF Conversion MDT].
...
image::img/dg_publish_publish.png[]

[[pub_con]]
==== MDT in conversion-only mode

When using a hosted MDT in -only mode or the https://mdt.gbif.org/[GBIF Conversion MDT], publishing will require the user to contact the administrator of the MDT by using the link "*Ready to publish a dataset? Reach out to the administrator for assistance*".

NOTE: Users that have prepared a dataset using the https://mdt.gbif.org/[GBIF Conversion MDT] should investigate whether there is a relevant hosted MDT adminstered by a relevant GBIF node. #how can we guide here?#
...
image::img/dg_publish_demo2.png[]
