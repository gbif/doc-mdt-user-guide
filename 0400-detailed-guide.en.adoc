...
When using a hosted MDT in conversion mode or the https://mdt.gbif.org/[GBIF Conversion MDT], publishing will require the user to contact the administrator of the MDT by using the link "*Ready to publish a dataset? Reach out to the administrator for assistance*".
