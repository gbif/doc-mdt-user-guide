...
* Still learning or testing? Use the https://mdt.gbif-uat.org/[MDT Sandbox (Demo Installation)].
* Got a real dataset? Identify and use the most relevant hosted MDT installation for the dataset. #how can we guide here??#
* Can't find a relevant MDT installation? Use the https://mdt.gbif-uat.org/[GBIF Conversion MDT].
