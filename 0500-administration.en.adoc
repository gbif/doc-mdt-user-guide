...
| &#x2705;
| &#x274C; *
| *) For conversion MDT original input files could be updated, uploaded again, processed, and downloaded as updated DwC-A to replace the previous endpoint wherever it is hosted 
