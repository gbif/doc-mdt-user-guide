...
* Upload and process <<example2>> in the https://sandbox-mdt.gbif-uat.org/[MDT Sandbox (Demo Installation)] following the steps in the <<detailed_guidance>>
...
* Identify the most relevant MDT installation (read more here: <<installations>>).
* Upload and process the data in the MDT, while referring to the <<preparation_structure, preparation instructions>>, the <<detailed_guidance>>, the <<faq>>, and the <<glossary>> as needed.
