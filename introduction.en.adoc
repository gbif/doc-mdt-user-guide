...
IMPORTANT: #The guide refers to a https://sandbox-mdt.gbif-uat.org/[MDT Sandbox (Demo Installation)] and a https://mdt.gbif.org/[GBIF Conversion MDT]. These are not yet online! Use this test installation: https://mdt.gbif-uat.org/ with UAT your user profile for now.#
...
* Work through the <<simple_quick_start>> using the https://sandbox-mdt.gbif-uat.org/[MDT Sandbox (Demo Installation)].
