...
* <<admin>> (only visible to MDT managers)
* <<mydata>>
...
img::dg_invalid_format[][pdfwidth=10%,scaledwidth=10%]
...
img::dg_publish_demo.png[]

The GBIF demo MDT installation cannot publish to GBIF.org.
If you have processed a dataset in the demo MDT that you would like to publish properly to GBIF.org, you can do the following
* Publish the dataset to the GBIF TEST environment (UAT) (step 6 - Export), if you haven't already.
* If have identified a hosted MDT installation 
