...
Some example datasets are provided to illustrate the different templates and how to use them. The datasets are fictional or modified versions of real datasets, and they can e.g. be used to practice the steps in the <<quick_start>> and the <<detailed_guidance>> and as templates for your own datasets.
