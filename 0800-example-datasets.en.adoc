...
Some example datasets are provided to illustrate the different templates and how to use them. The datasets are fictional or modified versions of real datasets, and they can e.g. be used to practice the steps in the <<simple_quick_start>> and the <<detailed_guidance>> and as templates for your own datasets.

+NOTE: see also the guide to download formatted upload files for existing MDT datasets on GBIF.org: <<extract_examples>>
...
Download file(s): link:../example_data/example_data2.current.en.xlsx[Example Dataset 2].
